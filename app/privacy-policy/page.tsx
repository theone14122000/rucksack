  ...
  return (
    <div className="pt-24 pb-20 bg-brand-cream">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 border-b border-brand-turquoise/30 mb-12">
          <h1 className="font-editorial text-4xl sm:text-5xl font-bold text-brand-dark tracking-tight mb-4">
            Privacy Policy
          </h1>
        ...
        <div className="prose-brand space-y-8 text-sm text-brand-dark/85 leading-relaxed">
          <section>
            <h2 className="font-editorial text-xl font-bold text-brand-dark mb-3">
