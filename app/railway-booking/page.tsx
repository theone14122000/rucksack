...
const trainRoutes = [
  ...
  },
  {
    ...
    type: "Express",
    duration: "8–10 hrs",
    highlights: "Overnight train to Kalka, connect to Toy Train or cab to Shimla",
  },
  {
            ...
            {trainRoutes.map((route) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-editorial text-lg font-bold text-brand-dark">
                    {route.name}
                  </h3>
                  <span className="text-[10px] font-mono uppercase tracking-widest text-brand-turquoise bg-brand-dark px-2 py-0.5 rounded-card">
                    {route.type}
                  </span>
                </div>
