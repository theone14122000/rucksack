...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#5C5233] text-brand-cream pt-16 pb-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="pt-2 flex items-center gap-3">
              <a
                ...
                className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-[#5C5233] transition-colors"
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <div className="space-y-2.5 text-xs text-brand-cream/70">
              ...
              <p className="flex items-center gap-2">
                ...
                <a href="mailto:curate@rucksackadventures.com" className="hover:text-brand-cream transition-colors">
